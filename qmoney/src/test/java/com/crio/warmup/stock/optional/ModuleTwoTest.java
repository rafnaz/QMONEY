...
class ModuleTwoTest {
  ...
  void prepareUrl() throws Exception {
    ...
    String tiingoUrl = PortfolioManagerApplication
            .prepareUrl(trade,LocalDate.parse("2010-01-01"),token);

    //then
    String uri = "https://api.tiingo.com/tiingo/daily/AAPL/prices?startDate=2010-01-01&endDate=2010-01-01&token=abcd";
